...
\end{enumerate}
%
\textbf{Our chosen threshold density corresponds to a value similar to a density that would trigger another mesh refinement past level 12.  At these scales, Jeans length refinement is the most common because of the cold temperatures in the cloud core.}
