...
\end{equation}
For $z = 15$ and $\rm{H}_{0} = 70 \rm{km} \rm{s}^{-1} \rm{Mpc}^{-1}$, ... 
%====================================================================
\section{Results}
%====================================================================
...
\begin{figure*}
	...
	\begin{subfigure}{.5\textwidth}
  		...
  		\caption{Total number of Pop III stars in halos hosting new Pop III stars versus halo mass at the instance of star formation.}
  		\label{fig:totnump3_halomass_sidehist}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
  		\centering
  		\includegraphics[width=\columnwidth]{images/final_redshift_Np3_mass.pdf}
  		\caption{Total number of Pop III stars in all halos versus halo mass at the end of the simulation, at $z \approx 9$.}
  		\label{fig:final_redshift_Np3_mass}
	\end{subfigure}
	\caption{The number of Pop III stars per halo versus halo mass at the instance of Pop III star formation and the final redshift. On the left, a Pop III star will form in a halo which contains a median number of four Pop III stars, with some containing as many as 16 Pop III stars. On the right, the red line indicates the median number of Pop III stars in each halo mass bin.}
\end{figure*}
