...
If within \textbf{10} pc, multiple cells meet this criteria, then a single Pop III star forms at the center of mass of these cells.\textbf{Our simulation is insensitive to the merging distance between Pop III stars.} The mass of the Pop III star is randomly sampled from an initial mass function (IMF) of the form:
