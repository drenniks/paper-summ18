...
\begin{itemize}
	...
	\item \hh{} self-shielding allows halos below the M01 mass relation, as small as half as previously thought, to cool and form Pop III stars.  Self-shielding creates a disconnect between the LW intensity and the collapse, resulting in a broad mass distribution of metal-free star forming halos and no strict correlation between the two quantities.
	...
	\item By the end of the simulation, halos with masses $>10^{7} M_{\odot}$ acquire multiple Pop III stars due to mergers with smaller mass halos, resulting galaxies with young and old metal-free stars. 
\end{itemize}
