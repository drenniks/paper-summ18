...
\end{referee}
    The shielding factor increases for more massive halos because these halos have larger virial radii, at which point there is significantly less \hh{} compared to the halo's interior. So halos with smaller masses, and thus smaller virial radii, have a higher \hh{} fraction in their outer regions compared to their larger counterparts, resulting in a more effective H2 shield.

    \jhw{Possibly revise after using piecewise fitting function.}
