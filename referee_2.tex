...
\end{referee}
    ...
    --Added to the caveats

    \jhw{I've add some wording in Sections 2.2.1 and 3.3 about fragmentation and our study being a lower limit on the multiplicity but nothing to the caveats section. I think with these statements, we can argue in the response that changes throughout the text are not needed. Make the changes to the caveats section, and I'll write the rebuttal here.}
...
\end{referee}
	The limits from Schauer+19 have been added to Figure 10, and the previous description regarding the 21cm signal has been removed. 
	--conclusions from this?
	--weird to me how the units of the streaming velocities are different. Change this?
	--unbolded addition to citation in caveat section 

	--need to add the Hirano+18 science paper to caveats section

	Schauer+19 and Hirano+18 have been added to the introduction (unbolded -- fix this?).
